...
Full-bench gen 0 & clean-room + instrument & \textbf{53/77} & first contact on seven unseen suites \\
\rowcolor{soft} Full-bench gen 1 & + grown library & \textbf{45/77} & the consultation tax, measured: $0\rightarrow9.1$ library reads/run \\
\rowcolor{soft} \multicolumn{4}{@{}l@{}}{\textit{Matched-cell comparison (the same 53 cells all three generations ran):}} \\
\multicolumn{2}{@{}l}{gen 0 (no library) \textbf{40} \ \ $\vert$ \ \ gen 1 (41 entries) \textbf{34} \ \ $\vert$ \ \ gen 1b (15-entry constitution) \textbf{34}} & & \\
\bottomrule
\end{tabularx}
